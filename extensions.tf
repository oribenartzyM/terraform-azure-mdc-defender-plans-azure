...
resource "azurerm_subscription_policy_assignment" "Log-Analytics-Arc1-autoprovisioning" {
  count = contains(var.mdc_plans_list, "VirtualMachines") ? 1 : 0
...
resource "azurerm_subscription_policy_assignment" "Log-Analytics-Arc2-autoprovisioning" {
  count = contains(var.mdc_plans_list, "VirtualMachines") ? 1 : 0
